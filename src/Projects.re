...
let geobingan2 = [%bs.raw "require('assets/screenshots/geobingan_2.png')"];
let ml0 = [%bs.raw "require('assets/screenshots/depth.png')"];
let ml1 = [%bs.raw "require('assets/screenshots/ml_spot_pipeline.png')"];
...
let geobinganIOS2 = [%bs.raw "require('assets/screenshots/geobingan_ios_2.jpg')"];
let geobinganIOS3 = [%bs.raw "require('assets/screenshots/geobingan_ios_3.jpg')"];
let sixmedia0 = [%bs.raw "require('assets/screenshots/6media_0.png')"];
let sixmedia1 = [%bs.raw "require('assets/screenshots/6media_1.png')"];
let sixmedia2 = [%bs.raw "require('assets/screenshots/6media_2.png')"];
let sixmedia3 = [%bs.raw "require('assets/screenshots/6media_3.png')"];
...
let streetlightSurvey: ProjectInfo.projectInfo = {
...
let awsInfra: ProjectInfo.projectInfo = {
...
let ballcast: ProjectInfo.projectInfo = {
  title: "Ballcast",
  media: [|
...
Backend tooling included python data crawlers running on AWS Lambdas, I also used AWS Amplify managed AWS AppSync for real-time graphql subscriptions. React and ReasonReact was used on the client side where three.js and pixi.js was leveraged for several 3d and 2d visualization tasks.",
  stackComponents: [|"opencv", "keras", "react", "electron", "reasonml", "pixi.js", "three.js", "aws-amplify"|]
};

let ami: ProjectInfo.projectInfo = {
  title: "A-Mi Project",
  media: [|
...
let ambientlight: ProjectInfo.projectInfo = {
  title: "Ambientlight",
  media: [|
...
let make = () => 
  <>
    ...
    <ProjectInfo info=awsInfra/>
    <ProjectInfo info=ballcast/>
    <ProjectInfo info=ami/>
    <ProjectInfo info=geobinganiOS/>
    <ProjectInfo info=ambientlight/>
    <ProjectInfo info=sixmedia/>
  </>